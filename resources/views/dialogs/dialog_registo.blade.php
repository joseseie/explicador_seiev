<div class="container-fluid modal fade" tabindex="-1" role="dialog" id="dialog-registo">
    <div class="row modal-dialog col-md-2" id="modal-dialog">


        <!-- Formulario de registo do Utilizador -->
        <div class="card-block" id="">
            <form action="dao/processar/processar_registo.php" method="POST" name="reg_form_registo" id="reg_form_registo">
                <!--Header-->
                <div class="text-left">
                ...
                <div class="md-form">
                    ...
                    <input type="text" id="reg_user_name" name="reg_user_name" class="form-control">
                    <label for="reg_user_name">Seu nome</label>
                    <i style="" class="form-control-feedback bv-icon-input-group glyphicon glyphicon-remove" data-bv-icon-for="email"></i>
                </div>

                <div class="md-form">
                    <i class="fa fa-envelope prefix"></i>
                    <input type="text" id="reg_email" name="reg_email" class="form-control">
                    <label for="reg_email">Seu email</label>
                </div>
                ...
                <div class="md-form">
                    <i class="fa fa-tag prefix"></i>
                    <input type="password" id="reg_password_confirmacao" name="r_password_confirmacao" class="form-control">
...
<!--        Formulario de criacao de login-->
        ...
        <div class="card-block" id="reg_form_perfil">
            ...
            <div class="custom-controls-stacked">
                <label class="custom-control custom-radio">
                    <input id="radioStacked1" name="rbEstudante" type="radio" value="Estudante" class="custom-control-input">
                    <span class="custom-control-indicator"></span>
                    <span class="custom-control-description">Perfil Estudante</span>
                </label>
                <label class="custom-control custom-radio">
                    <input id="radioStacked2" name="rbEstudante" type="radio" value="Explicador" class="custom-control-input">
                    <span class="custom-control-indicator"></span>
                    <span class="custom-control-description">Perfil Explicador</span>
                    <input type="hidden" id="tipoLogin" name="tipoLogin" >
                </label>
            </div>
        ...
        <!--Formulario de Login-->
        <div class="card-block" id="reg_form_login" action="dao/processar/processar_login.php" method="POST" name="form_login">
            <form class="card-block" id="form_login" action="dao/processar/processar_login.php" method="POST" name="form_login">
